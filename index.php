...
<head>
  ...
  <link rel="icon" href="img/logosmp4.png">
    ...
    <div class="container-fluid">
      ...
      <nav id="nav-menu-container">
        <ul class="nav-menu">
          ...
          <li><a href="indek.php">Koleksi Buku</a></li>          
      ...
      <div id="introCarousel" class="carousel  slide carousel-fade" data-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
          ...
          <div class="carousel-item active">
            <div class="carousel-background"><img src="img/intro-carousel/IMG_7035.jpg" alt=""></div>
          ...
          <div class="carousel-item">
            <div class="carousel-background"><img src="img/intro-carousel/6.jpeg" alt=""></div>
            <div class="carousel-container">
          ...
          <div class="carousel-item">
            <div class="carousel-background"><img src="img/intro-carousel/7.jpeg" alt=""></div>
            <div class="carousel-container">
              <div class="carousel-content"><br>
          ...
          <div class="carousel-item">
            <div class="carousel-background"><img src="img/intro-carousel/8.jpeg" alt=""></div>
            <div class="carousel-container">
              <div class="carousel-content"><br>
      ...
      <div class="container">
        ...
        <div class="row about-cols">
          ...
          <div class="col-md-4 wow fadeInUp">
            <div class="about-col">
              <div class="img">
                <img src="img/DSC_0725.jpg" alt="" class="img-fluid">
          ...
          <div class="col-md-4 wow fadeInUp" data-wow-delay="0.1s">
            <div class="about-col">
              <div class="img">
                <img src="img/IMG_3183.jpg" alt="" class="img-fluid">
          ...
          <div class="col-md-4 wow fadeInUp" data-wow-delay="0.2s">
            <div class="about-col">
              <div class="img">
                <img src="img/DSC02549.jpg" alt="" class="img-fluid">
        ...
        <div class="row contact-info">
          ...
          <div class="col-md-4">
            <div class="contact-address">
              ...
              <h3>Address</h3>
              <a href="http://bit.ly/LokSMP4"><address>jl. Kolonel Suwignyo 45, Lumajang 67311</address></a>
            </div>
          </div>
...
<!--         <div class="form">
 ...
 -->
  ...
  <footer id="footer">
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 footer-info">
            <br><br><br><br><br><h3>S-Library</h3>
            <p></p>
          </div>

          <div class="col-lg-3 col-md-6 footer-links nav-menu-container">
            <h4>Link Pintasan</h4>
            <ul>
              <li><i class="ion-ios-arrow-right"></i> <a href="indek.php">Home</a></li>
              <li><i class="ion-ios-arrow-right"></i> <a href="#portfolio">Koleksi</a></li>
          ...
          <div class="col-lg-3 col-md-6 footer-contact">
            <h4>Media Sosial SMPN 4 Lumajang</h4>
    ...
    <div class="container">
      <div class="copyright">
        &copy;<strong> 2020</strong> Perpustakaan SMP Negeri 4 Lumajang
      </div>
    </div>
  </footer><!-- #footer -->
