...
<div class="panel-content">
    ...
    <div class="modal fade Pinjam" tabindex="-2" role="dialog">
        <div class="modal-dialog modal-lg">
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <div class="col-md-10 col-md-offset-1">
                        ...
                        <div class="form-group">
                            <label for="pengarang">Jenis Anggota</label>
                        ...
                        <div class="form-group">
                            <label for="halaman">Jumlah Buku</label>
                        ...
                        <div class="form-group">
                            <label for="sinopsis">Pengarang</label>
            ...
            <div class="modal-footer">
                <div class="col-md-4 col-md-offset-4">
                        <button type="submit" class="c-btn large green-b  g" name="update">Submit</button>
                        <button type="button" class="c-btn large red-bg" data-dismiss="modal">Batal</button>
                </div>
            </div>
            </form>            
