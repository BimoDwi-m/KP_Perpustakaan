  ...
  <div class="container relative">
    <div class="row">
      ...
      <div class="col-sm-6 col-xs-12 mb-60">
        ...
        <div class="flickity  mfp-hover" id="gallery-main">
          ...
          <div class="gallery-cell">
            <a href="<?= base_url("assets/img/book/$row[cover]") ?>" class="lightbox-img">
      ...
      <div class="col-sm-6 col-xs-12 product-description-wrap">
        <h1 class="product-title"><?= $row['judul_buku']; ?></h1>
        <span>
          <?php
          $x = $row['rating'];
          $j = 5 - $x;
        ...
        <div class="product_meta">
          <table class="table table-hover table-responsive">
            ...
            <tr>
              ...
              <td><a href="<?= base_url('buku') ?>?id_kat=<?= $row['id_kategori'] ?>&halaman=1" target="_blank">
                  <?= $row['judul_kategori']; ?></a></span></td>
            </tr>
          </table>
          <!-- tabs -->
          <div class="row">
              ...
              <div class="tabs tabs-bb">
                ...
                <div class="tab-content">
                  ...
                  <div class="tab-pane fade in active" id="tab-description">
                    <p align="justify">
                      <?= htmlspecialchars_decode(stripcslashes($row['sinopsis'])); ?>
                    </p>
                  </div>

                  <div class="tab-pane fade" id="tab-info">
                    <div class="col-md-12">
                      <form action="<?= base_url('vendor/proses.php') ?>" name="komentar" method="post">
                        <input name="id_buku" type="hidden" value="<?= $_GET['id_buku']; ?>">
                        ...
                        <?php if (mysqli_num_rows($rsKomentar) == 0) { ?>
                          ...
                          ?>
                            <li>
                              <div class="review-body">
                                <div class="review-content">
                                  <p class="review-author"><strong><?= $row['nama']; ?></strong><small> - <?= $row['tgl']; ?></small></p>
                                  <p align="justify">
                                    <?php
                                    if ($row['hapus'] == 0)
